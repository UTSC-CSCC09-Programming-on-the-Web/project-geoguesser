...
streetviewRouter.post("/ai-review", async (req, res) => {
  try {
    ...
    const aiInstructionForHint =
      "You are a GeoGuesser coach. Analyze this image and give the player a useful location hint.Give exactly 1 to 2 concise sentences about where this location might be. Use visible clues such as signs, language, road markings, architecture, vegetation, utility poles, vehicles, license plates, and road quality. Indicate a region, or broad climate/landscape clue. Do not provide an exact city or country. Do not reveal GPS coordinates or hidden metadata. Be honest about uncertainty and do not state an unsupported exact location.";
